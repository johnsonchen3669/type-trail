...
import { Question, QuestionId, QuizAnswers, QuizOption } from './quiz.models';
...
export class QuizPage {
  ...
  private readonly restored = this.progressStore.load(this.quiz.id);
  protected readonly answers = signal<QuizAnswers>(this.restored?.answers ?? {});
  protected readonly submitted = signal(this.restored?.status === 'submitted');
